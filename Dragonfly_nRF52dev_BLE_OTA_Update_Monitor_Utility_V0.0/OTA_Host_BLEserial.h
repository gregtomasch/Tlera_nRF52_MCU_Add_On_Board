...
#define INBUF_SIZE                     512                                                            // 512 is a good size for general use
#define RX_ACK_NAK_BYTE                14                                                             // Command 14, receive command to handle ACK/NAK byte from the remote STM32L4
