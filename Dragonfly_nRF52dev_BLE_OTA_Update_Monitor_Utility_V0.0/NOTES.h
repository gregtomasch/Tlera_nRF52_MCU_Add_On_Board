/*
 1/30/18 V0.0
 This sketch is used on a Dragonfly STM32L4 MCU development board and in conjunction with an nRF52 add-on board to serve as a BLE/UART bridge for Peripheral role Nordic UART Service (NUS) devices
 ...
 4) The transfer is designed to be robust to common problems:
    a) When the nRF52 central pairs with the target nRF52 Dragonfly pin 21 is pulled low indicating the BLE/UART bridge is ready. In not, data will not transfer until it is
