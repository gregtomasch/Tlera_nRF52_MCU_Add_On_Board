...
int           blueLed = myLed3;                                                                            // Blue LED indicator
...
void setup()
{
  ...
  Serial1.begin(115200);                                                                                   // Serial1 is for the BLE link
  delay(1000);
...
{  
  ...
  Serial1.println("Green LED ON");                                                                         // Push "Green LED ON" message over the BLE/UART bridge
  delay(100);                                                                                              // Wait 1 second
  digitalWrite(myLed1, !digitalRead(myLed1));                                                              // Toggle green led off
  delay(1000);
  digitalWrite(myLed2, !digitalRead(myLed2));
  Serial1.println("Red LED ON");
  delay(100);
  digitalWrite(myLed2, !digitalRead(myLed2));
  delay(1000);
