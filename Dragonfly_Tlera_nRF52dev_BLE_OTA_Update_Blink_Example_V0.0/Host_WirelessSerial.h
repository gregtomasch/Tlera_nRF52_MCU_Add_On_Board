...
#define TX_BUFFER_SIZE                 512                                                            // Large enough to hold a whole OTA packet with plenty of margin
#define INBUF_SIZE                     512                                                            // Large enough to hold a whole OTA payload with plenty of margin
...
#define BLE_UART                       1                                                              // Dragonfly UART port connected to the nRF52 add-on board to constitute the UART/BLE bridge
