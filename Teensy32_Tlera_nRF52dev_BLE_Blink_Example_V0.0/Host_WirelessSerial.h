...
#define UART_NUMBER                    4                                                              // Total number of possible serial ports on the Teensy
#define TX_BUFFER_SIZE                 512                                                            // 512 is a good size for general use
#define INBUF_SIZE                     512
#define DATA_BLOCK_SIZE                32                                                             // FW file data block size; 32 bytes works well for the NUS UART pass-through without HW flow control
...
#define TEENSY_BLE_UART                1                                                              // Butterfly UART port connected to the nRF52 to constitute the UART/BLE bridge
