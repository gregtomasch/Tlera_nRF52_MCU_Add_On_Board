...
void BLEserial::Initiate_OTA_Update()
{
  ...
  cmdBLEserial[STM32L4_BLE_UART] = 12;                                                                                  // Call CMD 12, "INITIATE_OTA_UPDATE" payload 6 bytes
  BLEserial::headSerialRequest(STM32L4_BLE_UART, 0, 6);
  BLEserial::serialize32(OTA_Update_Size);
  BLEserial::serialize16(OTA_Update_Blocks);
  BLEserial::tailSerialRequest(STM32L4_BLE_UART);
}
...
{
  CURRENTPORT = STM32L4_BLE_UART;
  cmdBLEserial[STM32L4_BLE_UART] = 13;                                                                                  // Call CMD 13, "RECEIVE_OTA_DATA" payload OTA_DATA_BLOCK_SIZE+2 bytes
  BLEserial::headSerialRequest(STM32L4_BLE_UART, 0, OTA_DATA_BLOCK_SIZE+2);
...
*
* @brief: "Serialize" a 16bit unsigned integer into two bytes for serial transmission
* @params:
* @returns:
*/
